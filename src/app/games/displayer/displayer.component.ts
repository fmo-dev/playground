...
export class DisplayerComponent implements AfterViewInit, OnInit {
  ...
  displayGame(): void {
    const resolver: ComponentFactory<Game> = this.componentFactoryResolver.resolveComponentFactory(this.selectedGame.component);
  ...
  onBackToMenu = () => this.backToMenu.emit();
